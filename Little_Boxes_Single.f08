...
program main 
    ...
    open(1, file="results/spin_up.dat", status="replace")
    open(2, file="results/spin_down.dat", status="replace")
    open(3, file="results/photon_counting.dat", status="replace")
    open(4, file="results/emission_tracking.dat", status="replace")

    open(5, file="results/eta_0.dat", status="replace")
    open(6, file="results/xi_0.dat", status="replace")
    open(7, file="results/eta_1.dat", status="replace")
    open(8, file="results/xi_1.dat", status="replace")
